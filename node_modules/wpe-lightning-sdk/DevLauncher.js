...
export default class DevLauncher {
    ...
    launch(appType, lightningOptions, options = {}) {
        ...
        //console.log('this._appType: ' + this._appType);
        this._options = options;
        console.log('this._options: ' + this._options.toString());
        
        console.log('lightningOptions: ' + lightningOptions.toString());
...
body {
    ...
    _getLightningOptions(customOptions = {}) {
        ...
        if (!config.memoryPressure) {
            console.log("memoryPressure variable is being set");
            ...
            if (memoryPressure) {
                ...
                console.log('Could not get memoryPressure property from ux.Ui.getOption(\'memoryPressure\')\r\nSetting to 376M manually');
                config.memoryPressure = 376e6;
            }
        } else {
            console.log("memoryPressure variable is not being set");
        }
